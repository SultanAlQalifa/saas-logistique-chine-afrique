...
const navigation = [
  ...
  { name: 'Cargos', href: '/admin/cargos', icon: Ship },
            ...
            {navigation.map((item) => {
              ...
              return (
                <Link
                  key={item.name}
                  href={item.href}
                  className="flex items-center px-3 py-2 text-sm font-medium rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-900"
                >
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200">
          <div className="flex h-16 items-center px-4 border-b border-gray-200">
            ...
            <span className="ml-2 text-lg font-semibold text-gray-900">Admin Entreprise</span>
          </div>
          <nav className="flex-1 px-4 py-4 space-y-2">
            {navigation.map((item) => {
              const Icon = item.icon
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              ...
              <div className="flex items-center gap-x-3">
                <div className="text-sm">
                  ...
                  <p className="text-blue-600 font-semibold">{session?.user?.company?.name || 'Administrateur'}</p>
                </div>
